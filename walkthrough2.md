...
├── sql/schema.sql             # MySQL schema (20+ tabel, seed 31 kecamatan)
├── views/
...
|------|--------|-----------|
| [sql/schema.sql](file:///c:/laragon/www/se2026-jember/sql/schema.sql) | NEW | 20+ tabel MySQL + seed 31 kecamatan |
| [config/config.php](file:///c:/laragon/www/se2026-jember/config/config.php) | MODIFIED | + Session, roles, upload config, MySQL Support |
...
> [!NOTE]  
> Login membutuhkan MySQL aktif dengan tabel `users`. Tanpa DB, semua halaman public tetap bisa diakses.
